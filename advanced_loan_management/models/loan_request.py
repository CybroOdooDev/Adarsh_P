...
class LoanRequest(models.Model):
    ...
    loan_amount = fields.Float(string="Loan Amount",
                               help="Total loan amount",related="loan_type_id.loan_amount", readonly=True )
    disbursal_amount = fields.Float(string="Disbursal Amount",
                                    help="Total loan amount "
                                         "available to disburse",related="loan_type_id.disbursal_amount",readonly=True )
    tenure = fields.Integer(string="Tenure", default=1,
                            help="Installment period",related="loan_type_id.tenure",readonly=True)
    interest_rate = fields.Float(string="Interest Rate", help="Interest "
                                                              "percentage",related="loan_type_id.interest_rate",readonly=True)
