...
class LoanRequest(models.Model):
    ...
    disbursal_amount = fields.Float(string="Disbursal_amount", related="loan_type_id.disbursal_amount",
                                    help="Total loan amount "
                                         "available to disburse")
    tenure = fields.Integer(string="Tenure", related="loan_type_id.tenure",
                            help="Installment period")
    interest_rate = fields.Float(string="Interest rate", related="loan_type_id.interest_rate",help="Interest "
                                                              "percentage")
