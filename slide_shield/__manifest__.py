# -*- coding: utf-8 -*-
{
    'name': 'Slide Shield – eLearning Content Protection',
    'version': '19.0.1.0.0',
    'category': 'eLearning',
    ...
    'description': """
        ...
        Protection techniques (browser-side, no server changes needed):
    ...
    'assets': {
        'web.assets_frontend': [
            'slide_shield/static/src/css/shield.css',
            'slide_shield/static/src/js/shield.js',
            'slide_shield/static/src/js/vdocipher_lesson_player.js',
            'slide_shield/static/src/js/vdocipher_player.js',
        ],
    },
    'installable': True,
    'application': False,
